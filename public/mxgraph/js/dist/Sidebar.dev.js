...
Sidebar.prototype.init = function () {
  var dir = STENCIL_PATH; //edit by eddy
  ...
  this.addUmlPalette(true); //this.addBpmnPalette(dir, false);
  ...
  if (this.enableTooltips && this.showTooltips) {
    if (this.currentElt != elt) {
      ...
      var show = mxUtils.bind(this, function () {
        ...
        var top = Math.min(bottom - height - 20
        /*status bar*/
        , Math.max(0, this.editorUi.container.offsetTop + this.container.offsetTop + elt.offsetTop - this.container.scrollTop - height / 2 + 16)) + off.y;
...
Sidebar.prototype.addUmlPalette = function (expand) {
  ...
  */
  ...
  /* this.createVertexTemplateEntry('shape=umlLifeline;perimeter=lifelinePerimeter;whiteSpace=wrap;html=1;container=1;collapsible=0;recursiveResize=0;outlineConnect=0;', 
  100, 
  300, 
  ':Object', 
  'Lifeline', 
  ...
  this.addEntry('uml sequence invoke invocation call activation', function () {
    var cell = new mxCell('', new mxGeometry(0, 0, 100, 300), 'shape=umlLifeline;perimeter=lifelinePerimeter;whiteSpace=wrap;html=1;container=1;collapsible=0;recursiveResize=0;outlineConnect=0;');
    cell.vertex = true;
    cell.value = ":Object";
    cell.modelo = "lifeLine";
    return sb.createVertexTemplateFromCells([cell], 100, 300, 'LifeLlne');
  }), this.addEntry('uml sequence invoke invocation call activation', function () {
    var cell = new mxCell('', new mxGeometry(0, 0, 20, 300), 'shape=umlLifeline;participant=umlActor;perimeter=lifelinePerimeter;whiteSpace=wrap;html=1;container=1;collapsible=0;recursiveResize=0;verticalAlign=top;spacingTop=36;outlineConnect=0;');
    cell.vertex = true;
    cell.value = "Actor";
    cell.modelo = "actor";
    return sb.createVertexTemplateFromCells([cell], 20, 300, 'Actor');
  }), this.addEntry('uml sequence invoke invocation call activation', function () {
    var cell = new mxCell('', new mxGeometry(0, 0, 50, 300), 'shape=umlLifeline;participant=umlBoundary;perimeter=lifelinePerimeter;whiteSpace=wrap;html=1;container=1;collapsible=0;recursiveResize=0;verticalAlign=top;spacingTop=36;outlineConnect=0;');
    cell.vertex = true;
    cell.value = "";
    cell.modelo = "lifeline";
    return sb.createVertexTemplateFromCells([cell], 50, 300, 'Boundary');
  }), this.addEntry('uml sequence invoke invocation call activation', function () {
    var cell = new mxCell('', new mxGeometry(0, 0, 40, 300), 'shape=umlLifeline;participant=umlEntity;perimeter=lifelinePerimeter;whiteSpace=wrap;html=1;container=1;collapsible=0;recursiveResize=0;verticalAlign=top;spacingTop=36;outlineConnect=0;');
    cell.vertex = true;
    cell.value = "";
    cell.modelo = "lifeline";
    return sb.createVertexTemplateFromCells([cell], 40, 300, 'Entity');
  }), this.addEntry('uml sequence invoke invocation call activation', function () {
    var cell = new mxCell('', new mxGeometry(0, 0, 40, 300), 'shape=umlLifeline;participant=umlControl;perimeter=lifelinePerimeter;whiteSpace=wrap;html=1;container=1;collapsible=0;recursiveResize=0;verticalAlign=top;spacingTop=36;outlineConnect=0;');
    cell.vertex = true;
    cell.value = "";
    cell.modelo = "lifeline";
    return sb.createVertexTemplateFromCells([cell], 40, 300, 'Control');
  }),
  ...
  this.createVertexTemplateEntry('shape=umlFrame;whiteSpace=wrap;html=1;', 300, 200, 'frame', 'Frame', null, null, 'uml sequence frame'), this.createVertexTemplateEntry('shape=umlDestroy;whiteSpace=wrap;html=1;strokeWidth=3;', 30, 30, '', 'Destruction', null, null, 'uml sequence destruction destroy'), this.addEntry('uml sequence invoke invocation call activation', function () {
    ...
    cell.vertex = true;
    var edge = new mxCell('dispatch', new mxGeometry(0, 0, 0, 0), 'html=1;verticalAlign=bottom;startArrow=oval;endArrow=block;startSize=8;type=accion');
